...
More info on the curation of secretory tasks and the updated metabolic model can be found at the repository [xavierbemo/secretory-tasks](https://github.com/xavibemo/secretory-tasks).
